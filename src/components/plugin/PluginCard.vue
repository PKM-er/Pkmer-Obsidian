		...
		<div class="flex flex-col items-start h-full gap-4 p-6">
			...
			<div class="relative w-full space-y-2">
				...
				<div class="relative">
					...
					<img v-show="pluginInfo.banner" class="object-cover w-full h-52 rounded-xl" :src="pluginInfo.banner?.replace('gif!pkmer','gif').replace('!pkmer','!nomark')" :alt="pluginInfo.name"
